...
class WebSocketCore extends index.EventDispatcherCore {
  constructor() {
    super(...arguments);
  ...
  deserialize(e) {
    ...
    try {
      ...
      index$1.Logger.error("WebSocket deserialize JSON Data Error >>", error);
      return null;
    }
  }
  serializer(data) {
  ...
  initWebSocket(path) {
    var _a, _b;
    index$1.Logger.log(`[WebSocketCore] start connect to ${path} using ${this.useBinary ? "arraybuffer" : "string"} protocol`);
    if (this.useBinary) {
  ...
  callServer(data) {
    var _a;
    index$1.Logger.log("[CallServer]", data);
...
//# sourceMappingURL=webSocketCore.js.map
