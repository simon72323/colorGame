...
var appTalkingBase = require('./appTalkingBase.js');

var __defProp = Object.defineProperty;
var __defNormalProp = (obj, key, value) => key in obj ? __defProp(obj, key, { enumerable: true, configurable: true, writable: true, value }) : obj[key] = value;
var __publicField = (obj, key, value) => __defNormalProp(obj, typeof key !== "symbol" ? key + "" : key, value);
class AppTalkingAio extends appTalkingBase.AppTalkingBase {
  constructor() {
    super();
  ...
  iosAppToJsMessage(...args) {
    index.Logger.log("iosAppToJsMessage", ...args);
  }
  ...
  jsToAppMessage(message) {
    if (detectDevice.DetectDevice.isAIO) {
      if (detectDevice.DetectDevice.iOS) {
        this.iosJsToAppMessage(message);
      } else if (detectDevice.DetectDevice.Android) {
...
exports.AppTalkingAio = AppTalkingAio;
//# sourceMappingURL=appTalkingAio.js.map
