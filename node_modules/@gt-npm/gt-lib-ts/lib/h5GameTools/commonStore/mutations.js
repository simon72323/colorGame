...
function useMutations(state) {
  class Mutations {
    ...
    onBeginGame(data) {
      ...
      index.Logger.log("[CommonStore::onBegingame]", data);
    ...
    onGetMachineList(data) {
      index.Logger.log("[CommonStore::onGetMachineList]", data);
    ...
    onOnLoadInfo(data) {
      var _a, _b, _c, _d;
      index.Logger.log("[CommonStore::onOnLoadInfo]", data);
    ...
    onGetMachineDetail(data) {
      index.Logger.log("[CommonStore::onGetMachineDetail]", data);
      state.balance = +data.Balance;
      state.credit = +data.Credit;
    ...
    onCreditExchange(data) {
      var _a, _b, _c;
      index.Logger.log("[CommonStore::onCreditExchange]", data);
    ...
    onBalanceExchange(data) {
      index.Logger.log("[CommonStore::onBalanceExchange]", data);
    ...
    onEndGame(data) {
      index.Logger.log("[CommonStore::onEndGame]", data);
      state.credit = +data.Credit;
      this.initState();
    }
    onKeepMachineStatus(data) {
      index.Logger.log("[CommonStore::onKeepMachineStatus]", data);
    }
    onDoubleGame(data) {
      index.Logger.log("[CommonStore::onDoubleGame]", data);
    }
    /** 設置押線 */
    setLine(line) {
      state.line = line;
