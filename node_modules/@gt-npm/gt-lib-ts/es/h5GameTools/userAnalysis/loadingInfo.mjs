...
${showString}`;
  ...
  sendLoadingTime() {
    ...
    const data = {
      ...
      HallID: UrlHelper.shared.hallId,
      UserID: this.userID,
      SessionID: UrlHelper.shared.sid,
    ...
    fetch(
      `${UrlHelper.shared.domain}/ipl/portal.php/game/casinofrontend_entrance/loadingtime`,
      {
        method: "POST",
        headers: {
...
export { LoadingInfo, TimeLabelKeys };
//# sourceMappingURL=loadingInfo.mjs.map
