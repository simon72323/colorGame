 ...
 */
export class WorkerTimeout {

    private static singleton: WorkerTimeout = null;
    ...
    public static getInstance(): WorkerTimeout {
        if (!WorkerTimeout.singleton) {
            WorkerTimeout.singleton = new WorkerTimeout();
        }
        return WorkerTimeout.singleton;
    }
