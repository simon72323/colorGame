...
export class CGBetArea extends Component {
    ...
    public onLoad(): void {
        this.gameManager = find('Canvas/MainScripts').getComponent(CGGameManager);
    ...
    private onBetAreaPressed(param: string): void {
        this.gameManager.chipController.createChipToBetArea(Number(param), 0, this.gameManager.chipSet.touchChipID, false);
